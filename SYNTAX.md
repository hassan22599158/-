...
للحصول على أفضل تنسيق للمعادلات العربية (من اليمين لليسار)، استخدم الكلمة `ar` في بداية المعادلة.

**القانون العام (يمين ليسار):**
`$$ar \text{س} = \frac{-\text{ب} \pm \sqrt{\text{ب}^2 - 4\text{أ}\text{ج}}}{2\text{أ}} $$`

**الأسس:**
`$$ar \text{س}^2 + \text{ص}^2 = 25 $$`
